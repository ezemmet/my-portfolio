...
const ServiceCard = ({ icon, heading, paragraph }) => {
    return (
        <div className='bg-[#1d1d1d] text-white lg:w-[25vw] lg:h-[30vh] text-center py-4 px-2 rounded-sm hover:translate-y-[-10px] hover:bg-red-500 transition-all ease-in-out duration-150'>
