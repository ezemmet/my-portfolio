  ...
  return (
    <div className='grid grid-cols-2 items-center h-[10vh] bg-[#0c0c0c] text-white px-[3rem] lg:px-[10rem]'>
      ...
      <div className='text-end'>
        ...
        <div className={`absolute right-0 top-[3.8rem] md:top-0 ${menu} md:relative md:block`}>
          <ul className='md:flex text-center md:justify-end font-fontKanit bg-[#000000d7]'>
