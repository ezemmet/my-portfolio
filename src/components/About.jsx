...
const About = () => {
    return (
        <div id='about' className='bg-[#1d1d1d] text-white grid lg:grid-cols-12 lg:h-[70vh] md:px-[5rem] py-[3rem] lg:text-start text-center justify-center'>
            <div className='lg:col-span-4 px-[3rem] py-[1rem] justify-center flex'>
                <div className='h-[20rem] w-[20rem] bg-gradient-to-b from-red-600 to-black via-red-600 rounded'>
                    {/* <img src={} alt="Nitin Sharma"/> */}
                </div>
            </div>

            <div className='lg:col-span-8 px-[2rem] py-[1rem] lg:h-[50vh]'>
